...
insert into issues(title,description,type, priority,status,assigned_to,created_by) values ('Home screen','need to create a home screen','bug','high','open','Donald Duck','Mickey Mouse');
